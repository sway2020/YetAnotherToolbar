...
namespace SamsamTS
{
    public class UIUtils
    {
        ...
        public static void CreateDropDownScrollBar(UIDropDown dropDown)
        {
            ...
            Vector3 newPosition = YetAnotherToolbar.YetAnotherToolbar.instance.mainButton.relativePosition;
            newPosition.x += 50000;
            newPosition.y += 50000;
        ...
        public static UISlider CreateSlider(UIComponent parent, float value, float min, float max, float step)
        {
            ...
            slider.size = new Vector2(350, 10);
